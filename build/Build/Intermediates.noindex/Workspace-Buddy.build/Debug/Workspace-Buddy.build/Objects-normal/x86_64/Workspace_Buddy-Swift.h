...
#ifndef WORKSPACE_BUDDY_SWIFT_H
#define WORKSPACE_BUDDY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Workspace_Buddy",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (BOOL)applicationSupportsSecureRestorableState:(NSApplication * _Nonnull)application SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC15Workspace_Buddy18CustomStatusButton")
@interface CustomStatusButton : NSView
